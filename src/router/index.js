...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: '/fzjczc/qyyytj/qyyb',
        name: '企业月报',
        component: () =>
          import('views/AssistantDecisionSupport/EnterpriseOperationStatistics/EnterpriseMonthlyReport.vue')
      },
      {
        path: '/fzjczc/qyyytj/qyrb',
        name: '企业日报',
        component: () =>
          import('views/AssistantDecisionSupport/EnterpriseOperationStatistics/EnterpriseDaily.vue')
      },
      {
        path: '/fzjczc/rcjcyj/wgyyyj',
        name: '违规营运预警',
        component: () =>
          import('views/AssistantDecisionSupport/DailyMonitoringEarlyWarning/ViolationOperationAnalysis.vue')
      },
      {
        path: '/fzjczc/rcjcyj/yqjyyj',
        name: '越区经营预警',
        component: () =>
          import('views/AssistantDecisionSupport/DailyMonitoringEarlyWarning/CrossAreaManagementMonitor.vue')
      },
      {
        path: '/fzjczc/cllcfx/cllcgl',
        name: '车辆里程管理',
        component: () =>
          import('views/AssistantDecisionSupport/VehicleMileageAnalysis/VehicleMileageManagement.vue')
      },
      {
        path: '/fzjczc/cllcfx/cllcyj',
        name: '车辆里程预警',
        component: () =>
          import('views/AssistantDecisionSupport/VehicleMileageAnalysis/VehicleMileageWarning.vue')
      },
      {
