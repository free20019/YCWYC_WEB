  ...
  <t-query-panel :model="query" size="medium">
    ...
    <template>
      ...
      >
        ...
        <el-table-column
          prop="UNITPRICEPERMILE"
          label="计程单价按公里"
          align="center"
          width="120"
        ></el-table-column>
        <el-table-column
          prop="UNITPRICEPERMINUTE"
          label="计时单价按分钟"
          align="center"
          width="120"
        ></el-table-column>
        ...
        <el-table-column
          prop="UPPRICESTARTMILE"
          label="单程加价公里"
          align="center"
          width="120"
        ></el-table-column>
        <el-table-column
          prop="MORNINGPEAKTIMEON"
          label="营运早高峰时间起"
          align="center"
          width="150"
        ></el-table-column>
        ...
        ></el-table-column>
        <el-table-column
          prop="NIGHTPRICEPERMILE"
          label="夜间费按公里"
          align="center"
          width="150"
        ></el-table-column>
        <el-table-column
          prop="NIGHTPRICEPERMINUTE"
          label="夜间费按分钟"
          align="center"
          width="150"
        ></el-table-column>
...
export default {
  ...
  methods: {
    getDataList() {
      ...
      const idata = `postData={'ptname':'${this.query.ptname}','yjlx':'${this.query.yjlx}','state':'${this.query.state}'}`
      ajaxT
