...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      let idata = `postData={'ptname':'${this.query.ptname}','state':'${this.query.state}','vehino':'${this.query.vehino}','pageIndex':'${this.table.currentPage}','pageSize':'${this.table.pageSize}' }`
      ajaxT
