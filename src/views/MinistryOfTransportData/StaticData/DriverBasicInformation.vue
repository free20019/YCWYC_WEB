  ...
  <t-query-panel :model="query" size="medium">
    ...
    <template>
      ...
      >
        ...
        <el-table-column
          align="center"
          prop="DRIVERMARITALSTATUS"
          label="驾驶员婚姻状况"
          width="120"
        ></el-table-column>
        <el-table-column
          align="center"
          prop="DRIVERLANGUAGELEVEL"
          label="驾驶员外语能力"
          width="120"
        ></el-table-column>
        <el-table-column
          align="center"
          prop="DRIVEREDUCATION"
          label="驾驶员学历"
          width="120"
        ></el-table-column>
        <el-table-column
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      let idata = `postData={'ptname':'${this.query.ptname}','jszh':'${this.query.jszh}','jsyname':'${this.query.jsyname}','pageIndex':'${this.table.currentPage}','pageSize':'${this.table.pageSize}' }`
      ajaxT
