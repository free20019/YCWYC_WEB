...
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <t-query-panel :model="query" size="medium">
        ...
        >
            ...
            <t-table-column prop="ADDRESS" label="上车地点行政区划代码" width="180"></t-table-column>
            <t-table-column prop="ORDERID" label="订单编号" width="180"></t-table-column>
            <t-table-column prop="ORDERTIME" label="订单时间" :formatter="formatterTableTime"  width="180"></t-table-column>
            <t-table-column prop="CANCELTIME" label="订单撤销时间" :formatter="formatterTableTime"  width="180"></t-table-column>
            <t-table-column prop="OPERATOR" label="撤销发起方"  :formatter="formatterOperator" width="180"></t-table-column>
            <t-table-column prop="CANCELTYPECODE" label="乘客撤销"  :formatter="formatterCancelTypeCode" width="180"></t-table-column>
            <t-table-column prop="CANCELREASON" label="撤销或违约原因" width="180"></t-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      formatterCancelTypeCode(a, b, val) {
        if(val=== '1'){
          return '乘客撤销';
        }else if(val==='2'){
          return '驾驶员撤销';
      ...
      getData(data) {
        ...
        return ajaxT.post('dynamicData/findOrderCancel', params).then(res => res.data)
      },
