...
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <t-query-panel :model="query" size="medium">
        ...
        >
            ...
            <t-table-column prop="COMPLAINTTIME" label="投诉时间" :formatter="formatterTableTime"  width="180"></t-table-column>
            <t-table-column prop="DETAIL" label="投诉内容" width="180"></t-table-column>
            <t-table-column prop="RESULT" label="处理结果" width="180"></t-table-column>
...
<script>
  ...
  export default {
    name: 'PassengerComplaintInformation',
    data() {
      return {
        query: {
          ptname: '0',
    ...
    methods: {
      ...
      getData(data) {
        ...
        return ajaxT.post('dynamicData/findRatedPassengerComplaint', params).then(res => res.data)
      },
