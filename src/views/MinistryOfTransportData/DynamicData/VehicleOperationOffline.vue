...
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <t-query-panel :model="query" size="medium">
        ...
        >
            ...
            <t-table-column prop="LOGOUTTIME" label="下线时间" :formatter="formatterTableTime" width="180"></t-table-column>
            <t-table-column prop="LONGITUDE" label="下线经度" width="180"></t-table-column>
            <t-table-column prop="LATITUDE" label="下线纬度" width="180"></t-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getData(data) {
        ...
        return ajaxT.post('dynamicData/findOperateLogout', params).then(res => res.data)
      },
