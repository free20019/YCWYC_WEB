...
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <t-query-panel :model="query" size="medium">
        ...
        >
            ...
            <t-table-column prop="LONGITUDE" label="车辆经度" width="180"></t-table-column>
            <t-table-column prop="LATITUDE" label="车辆纬度" width="180"></t-table-column>
            <t-table-column prop="ENCRYPTBS" label="坐标加密标识" :formatter="formatterEncryptBS" width="180"></t-table-column>
            <t-table-column prop="LICENSEID" label="机动车驾驶证编号" width="180"></t-table-column>
            <t-table-column prop="DRIVERPHONE" label="驾驶员手机号" width="180"></t-table-column>
            <t-table-column prop="VEHICLENO" label="车辆号牌" width="180"></t-table-column>
            <t-table-column prop="DISTRIBUTETIME" label="派单时间" :formatter="formatterTableTime" width="180"></t-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getData(data) {
        ...
        return ajaxT.post('dynamicData/findOrderMatch', params).then(res => res.data)
      },
