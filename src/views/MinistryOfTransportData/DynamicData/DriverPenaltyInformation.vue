...
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <t-query-panel :model="query" size="medium">
        ...
        >
            ...
            <t-table-column prop="PUNISHTIME" label="处罚时间" :formatter="formatterTableTime" width="180"></t-table-column>
            <t-table-column prop="PUNISHREASON" label="处罚原因" width="180"></t-table-column>
            <t-table-column prop="PUNISHRESULT" label="处罚结果" width="180"></t-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getData(data) {
        ...
        return ajaxT.post('dynamicData/findProvDriverPunish', params).then(res => res.data)
      },
