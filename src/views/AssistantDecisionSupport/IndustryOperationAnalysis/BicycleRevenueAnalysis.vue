        ...
        series: [
          {
            ...
            data:
              type == 'DUR_AVE'
                ? _.map(_.pluck(today, type), item => (item / 60).toFixed(2))
                : _.pluck(today, type)
          },
          {
            name: '昨日',
            ...
            data:
              type == 'DUR_AVE'
                ? _.map(_.pluck(yesterDay, type), item => (item / 60).toFixed(2))
                : _.pluck(yesterDay, type)
          },
          {
            name: '上周',
            type: 'line',
            data:
              type == 'DUR_AVE'
                ? _.map(_.pluck(lastWeek, type), item => (item / 60).toFixed(2))
                : _.pluck(lastWeek, type)
          },
          {
            name: '上月',
            type: 'line',
            data:
              type == 'DUR_AVE'
                ? _.map(_.pluck(lastMonth, type), item => (item / 60).toFixed(2))
                : _.pluck(lastMonth, type)
          }
        ]
      })
    }
