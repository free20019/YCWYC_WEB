...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      let idata = `postData={'ptname':'${this.query.ptname}','year':'${year}','phone':'${this.query.phone}','state':'${this.query.state}','pageIndex':'${this.table.currentPage}','pageIndex':'${this.table.currentPage}','pageSize':'${this.table.pageSize}'}`
      ajaxT
