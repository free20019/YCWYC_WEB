...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      let idata = `postData={'ptname':'${this.query.ptname}','year':'${year}','jszh':'${this.query.jszh}','pxkmc':'${this.query.pxkmc}','pageIndex':'${this.table.currentPage}','pageSize':'${this.table.pageSize}' }`
      ajaxT
