      ...
      >
        ...
        <el-table-column label="身份证号" align="center" width="200">
          <template slot-scope="scope">
            <span class="table-text" @click="handleTableClick(scope.row, 'sfzh')">{{
              scope.row.LICENSEID
            }}</span>
          </template>
        </el-table-column>
        <el-table-column label="服务车号" align="center" min-width="140">
          <template slot-scope="scope">
            <span class="table-text" @click="handleTableClick(scope.row, 'fwch')">{{
              scope.row.VEHICLENO
            }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" width="140" :resizable="false">
          <template slot-scope="scope">
            <el-button type="text" @click="handleTableClick(scope.row, 'detail')" size="small"
              >查看明细
            </el-button>
          </template>
        </el-table-column>
