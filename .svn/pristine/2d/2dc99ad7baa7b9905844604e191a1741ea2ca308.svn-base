...
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <t-query-panel :model="query" size="medium">
        ...
        >
            ...
            <t-table-column prop="LEVEL" label="服务质量信誉等级" width="180"></t-table-column>
            <t-table-column prop="TESTDATE" label="服务质量信誉考核日期" :formatter="formatterTableTime" width="180"></t-table-column>
            <t-table-column prop="TESTDEPARTMENT" label="服务质量信誉考核机构" width="180"></t-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getData(data) {
        ...
        return ajaxT.post('dynamicData/findRatedDriver', params).then(res => res.data)
      },
