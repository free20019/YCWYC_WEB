...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      if ((stime && moment(stime).format('YYYY-MM')) !== (etime && moment(etime).format('YYYY-MM')))
        return this.$message.error('无法跨月查询！')
